  ...
  const submitAction = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await fetchApi(endpoint, {
        ...
        body: JSON.stringify({
          employeeId:
            actionType !== "RETURN" ? actionForm.employeeId : undefined,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <DataTable
              ...
              columns={[
                ...
                { key: "reason", header: "Reason" },
                {
                  key: "date",
                  header: "Date",
                  render: (m: any) => new Date(m.createdAt).toLocaleString(),
                },
              ]}
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-950 rounded-xl p-6 border border-slate-200 dark:border-slate-800 space-y-4">
            <h3 className="text-lg font-semibold border-b border-slate-200 dark:border-slate-800 pb-2">
              Asset Status
            </h3>
